    ...
    while(true) {
        ...
        switch(opcion) {
                ...
                while(!volver){
                    ...
                    switch (opcionSubMenu){
                        ...
                        case 3: //Modificar
                            fin = false;
                            while(!fin){
                                cout << "Introduzca la id del objeto que quiere modificar: " << endl;
                                cin >> id;
                                Cine cine = db.obtenerCine(id);
                                if(cine.getId() == -1){
                                    cout << "La id no es valida, desea volverlo a intentar (Y/N)" << endl;
                                    char respuesta;
                                    cin >> respuesta;
                                    if(respuesta=='N'){
                                        break;
                                ...
                                while(!fin_modificacion){
                                    cout << "Eliga que valor desea modificar (1-nombre, 2-direccion)";
                                    int seleccion;
                                    cin >> seleccion;
                        ...
                        case 4: //Eliminar
                            fin = false;
                            while (!fin){
                                cout << "Introduzca la id del objeto que desea eliminar: " << endl;
                                cin >> id;
                                Cine cine = db.obtenerCine(id);
                                if(cine.getId() == -1){
                                ...
                                cout << "Direccion: " << cine.getDireccion() << endl;
                                cout << "==========================================" << endl;
                                cout << "Para confirmar su eliminacion, escriba el nombre del cine: " << endl;
                                cin.ignore();
                                string confirmacion;
                    ...
                    switch (opcionSubMenu){
                        ...
                        case 3: //Modificar
                            ...
                            while(!fin){
                                ...
                                bool fin_modificacion = false;
                                while(!fin_modificacion){
                                    cout << "Eliga que valor desea modificar (1-titulo, 2-duracion, 3-genero)";
                                    int seleccion;
                                    cin >> seleccion;
                                    cout << "Introduzca el nuevo valor: " << endl;
                        ...
                        case 4: //Eliminar
                            ...
                            while (!fin){
                                ...
                                cout << "Vas a eliminar el objeto:" << endl;
                                consola.mostrarPelicula(pelicula);
                                cout << "Para confirmar su eliminacion, escriba el titulo de la pelicula: " << endl;
                                cin.ignore();
                                string confirmacion;
                                getline(cin, confirmacion);
                    ...
                    switch (opcionSubMenu){
                        ...
                        case 3: //Modificar
                            ...
                            while(!fin){
                                ...
                                bool fin_modificacion = false;
                                while(!fin_modificacion){
                                    cout << "Eliga que valor desea modificar (1-NumeroSala, 2-Filas, 3-Columnas)";
                                    int seleccion;
                                    cin >> seleccion;
                                    cout << "Introduzca el nuevo valor: " << endl;
                                    int nuevo_valor;
                        ...
                        case 4: //Eliminar
                            ...
                            while (!fin){
                                ...
                                cout << "Vas a eliminar el objeto:" << endl;
                                consola.mostrarSala(sala);
                                cout << "Para confirmar su eliminacion, escriba el numero de la sala con el siguiente formato (SALA x): " << endl;
                                cin.ignore();
                                string confirmacion;
                                getline(cin, confirmacion);
                    ...
                    switch (opcionSubMenu){
                        ...
                        case 3: //Modificar
                            ...
                            while(!fin){
                                ...
                                bool fin_modificacion = false;
                                while(!fin_modificacion){
                                    cout << "Eliga que valor desea modificar (1-Pelicula, 2-Sala, 3-Fecha/Hora)";
                                    int seleccion;
                                    cin >> seleccion;
                                    cout << "Introduzca el nuevo valor: " << endl;
                                    switch(seleccion){
                        ...
                        case 4: //Eliminar
                            ...
                            while (!fin){
                                ...
                                cout << "Hora: " << std::put_time(std::localtime(&hora), "%Y-%m-%d %H:%M:%S") << endl;
                                cout << "==========================================" << endl;
                                cout << "Para confirmar su eliminacion, escriba el titulo de la pelicula de la sesion: " << endl;
                                cin.ignore();
                                string confirmacion;
                                getline(cin, confirmacion);
            ...
            case 5:
                volver = false;
                while(!volver){
                    cout << "Desea ver las reservas de un cine o te toda la base de datos (1-cine, 2-todas):" << endl;
                    int seleccion;
                    cin >> seleccion;
                    if(seleccion == 1){
                        ...
                        cout << endl << "=== Reporte de Ocupación: " << cine.getNombre() << " ===" << endl;
                ...
                break;
            case 6:
                cout << "Gracias por usar el sistema administrador de gestión de cine" << endl;
                db.cerrarSQL();
                return 0;
            default:
                cout << "Opción no válida" << endl;
